...
export default function Form() {
    ...
    function onChangeInputEmail(e) {
        ...
        setTestEmail(re.test(e.target.value));
        setEmail(e.target.value);
    }

    function onChangeGenderInput(e) {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <fieldset>
                <legend>성별</legend>
                <label>여</label> <input type="radio" name="gender" value={ "female" } checked={ gender === 'female' } onChange={ onChangeGenderInput }/>
                <label>남</label> <input type="radio" name="gender" value={ "male" } checked={ gender === 'male' } onChange={ onChangeGenderInput }/>
            </fieldset>

            <label htmlFor="birthYear">생년</label>
            <select id="birthYear" defaultValue={ 1984 }>
            ...
            <textarea id='selfDescription' value={ '' } onChange={ () => {} }/>
