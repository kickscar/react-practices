## ex01: Component - Property: Composing Component

### 01. Property(줄여서 Props)
1. 컴포넌트 구성(Configuration) 정보
2. 컴포넌트 조합(Component Composition)과 작성에 중요한 역할을 한다.
3. 상위 컴포넌트에서 하위 컴포넌트로 전달되는 데이터로 Data Flow(Top-Down)의 메카니즘을 제공한다. 
